            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    ...
                    <li>
                        ...
                        <form action="{{route('admin.logout')}}" method="POST" id="logout_form" style="display: none;">
                            @csrf
                        </form>
                    </li>
                </ul>
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid text-muted small px-4 text-center">Copyright &copy; Your Website 2025</div>
            </footer>
        </div>
    </div>
